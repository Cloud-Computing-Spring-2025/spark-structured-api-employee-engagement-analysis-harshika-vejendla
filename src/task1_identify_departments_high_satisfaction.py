...
def main():
    ...
    # Define file paths
    input_file = "/workspaces/spark-structured-api-employee-engagement-analysis-harshika-vejendla/input/employee_data.csv"
    output_file = "/workspaces/spark-structured-api-employee-engagement-analysis-harshika-vejendla/outputs/task1/departments_high_satisfaction.csv"
